...
iterate_postfix: 	lb	$t0, postfix_($s1)
			...
			j iterate
			nop
		L5:   jal printf_result
		      nop 
		      j end_main
			
			nop	                                 # lenh tre
	      iterate:   beq	$t0, ' ', eliminate_space       # bieu thuc so sanh
			nop                                     # lenh tre
